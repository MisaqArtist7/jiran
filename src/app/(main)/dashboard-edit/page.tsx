...
export default function DashboardEdit() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    axios
      .post("https://jiran-api.com/api/v1/auth/edit-profile", formData, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
      .then((response) => {
        ...
        setUserId("");
        setBio("");
        return axios.get("https://jiran-api.com/api/v1/auth/show", {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        });
          ...
          <div className="bg-white shadow rounded-lg w-full p-3">
            <div className="flex flex-col justify-center items-start gap-2">
              ...
              <label
                ...
                className="mt-2 cursor-pointer text-[var(--primaryColor)] hover:underline text-sm"
              >
                Upload new photo
              </label>
              <input
            ...
            <form
              ...
              action=""
              className="flex flex-col justify-center gap-3 my-4 px-3 w-full"
            >
              ...
              <div className="flex items-center justify-between w-full">
                <label htmlFor="Bio" className="text-[var(--navy)]">
                  Bio
                </label>
                <input
                  type="text"
              ...
              <div className="flex items-center justify-between w-full">
                <label htmlFor="SocialLinks" className="text-[var(--navy)]">
                  Social Links
                </label>
                <input
                  type="text"
              ...
              <div className="w-full flex-row-center gap-2 p-3">
                <button
                  type="submit"
                  className="flex-row-center py-2.5 border border-[var(--primaryColor)] bg-[var(--primaryColor)] hover:bg-blue-600 text-white w-1/2 rounded transition-colors duration-75"
                >
                  Done
                </button>
                <button className="flex-row-center py-2.5 border border-red-600 text-red-600 w-1/2 rounded hover:bg-red-600 hover:text-white transition-colors duration-75">
                  Discard
                </button>
              </div>
            </form>
            ...
            <div>
              ...
              <form className="flex py-2">
                <div className="flex flex-col justify-center gap-3 w-full">
                  ...
                  <button
                    type="submit"
                    className="border border-[var(--primaryColor)] text-[var(--primaryColor)] rounded py-2 hover:bg-[var(--primaryColor)] hover:text-white"
                  >
                    Save Address
                  </button>
                </div>
